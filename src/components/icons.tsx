...
export const MoneyIcon = (props: IconSvgProps) => (
  <svg
    className="size-6"
    fill="none"
    stroke="currentColor"
...
export const ExperienceIcon = (props: IconSvgProps) => (
  <svg
    className="size-6"
    fill="none"
    stroke="currentColor"
...
export const PlaceOfWorkIcon = (props: IconSvgProps) => (
  <svg
    className="size-6"
    fill="none"
    stroke="currentColor"
...
export const DumbbellIcon = (props: IconSvgProps) => (
  <svg
    fill="none"
    height="24"
    stroke="currentColor"
